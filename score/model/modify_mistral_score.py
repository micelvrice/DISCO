...
def mistral_attn_forward_score(
    self,
    ...
    if not hasattr(self, "score_func"):
        coeffs = np.load(f"/home/sjx/ours/modify/get_score_function/full_fit_mistral_combined16_pca4.npy")
...
def mistral_model_forward_score(
    self,
